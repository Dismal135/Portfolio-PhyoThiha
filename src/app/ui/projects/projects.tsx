...
const Projects = () => {
    return (
        <section id="projects">
            ...
            <figure>
                <Image src={quoteMachine} alt="random quote machine" width={500} height={500} layout="responsive" />
                ...
                <figure>
                <Image src={documentation} alt="react technical documentation" width={500} height={500} layout="responsive" />
                ...
                <figure>
                <Image src={product} alt="product landing page" width={500} height={500} layout="responsive" />
                ...
                <figure>
                <Image src={tictactoe} alt="tic tac toe game" width={500} height={500} layout="responsive" />
